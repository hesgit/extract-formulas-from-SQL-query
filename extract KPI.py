...
file1 = open(r"E:\MTN\Huawei\3G\FACTS sql\huaweikpi_cell_60.sql", "r")
#file1 = open(r"E:\MTN\Huawei\LTE\FACTS imepelmentation\Huawei LTE- cellstats_60.sql", "r")

file3 = open(r"E:\MTN\Huawei\3G\FACTS sql\huaweikpi_cell_60-1.sql", "w")
#file3 = open(r"E:\MTN\Huawei\LTE\FACTS imepelmentation\Huawei LTE- cellstats_60-1.sql", "w")
